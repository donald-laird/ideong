...
type: docs
weight: 6
prev: docs/how-to-ask/05-on-not-reacting-like-a-loser
next: docs/how-to-ask/07-good-and-bad-questions
---
...
回答：如果你有足够的智慧提这个问题，你也该有足够的智慧去 [RTFM](https://github.com/HandSonic/HTQ?tab=readme-ov-file#RTFM)，然后自己去找出来。
