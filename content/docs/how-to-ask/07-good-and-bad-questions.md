...
type: docs
weight: 7
prev: docs/how-to-ask/06-questions-not-to-ask
next: docs/how-to-ask/08-good-and-bad-questions
---
...
这种问法无非想得到 [STFW](https://github.com/HandSonic/HTQ?tab=readme-ov-file#RTFM) 这样的回答。
